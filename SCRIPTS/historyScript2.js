var grid013 = document.getElementById('grid013');
var grid023 = document.getElementById('grid023');
var grid033 = document.getElementById('grid033');
...
var grid048 = document.getElementById('grid048');
var grid044 = document.getElementById('grid044');
var grid728 = document.getElementById('grid728');
var grid051 = document.getElementById('grid051');
var grid045 = document.getElementById('grid045');


function display2() {
    if (check4.checked == true) {
        grid013.style.width = "50%";
        grid023.style.width = "50%";
        grid033.style.width = "50%";
        ...
        grid048.style.width = "50%";
        grid044.style.width = "50%";
        grid728.style.width = "50%";
        grid051.style.width = "50%";
        grid045.style.width = "50%";

    }
    else {
        grid013.style.width = "100%";
        grid023.style.width = "100%";
        grid033.style.width = "100%";
        ...
        grid048.style.width = "100%";
        grid044.style.width = "100%";
        grid728.style.width = "100%";
        grid051.style.width = "100%";
