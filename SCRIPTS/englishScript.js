...
function learningGoals113() {
    if (more113.style.display === "inline")
    {
        more113.style.display = "none";
        learningGoalsBackground.style.padding = "2px 2px 2px 20px";
        
    }
    else
    {
        more113.style.display = "inline";
        learningGoalsBackground.style.padding = "2px 2px 15px 20px";
    }
}

function learningGoals123() {
    if (more123.style.display === "inline")
    {
        more123.style.display = "none";
        learningGoalsBackground.style.padding = "2px 2px 2px 20px";
        
    }
    else
    {
        more123.style.display = "inline";
        learningGoalsBackground.style.padding = "2px 2px 15px 20px";
    }
}

function learningGoals133() {
    if (more133.style.display === "inline")
    {
        more133.style.display = "none";
        learningGoalsBackground.style.padding = "2px 2px 2px 20px";
        
    }
    else
    {
        more133.style.display = "inline";
        learningGoalsBackground.style.padding = "2px 2px 15px 20px";
    }
}

function learningGoals138() {
    if (more138.style.display === "inline")
    {
        more138.style.display = "none";
        learningGoalsBackground.style.padding = "2px 2px 2px 20px";
        
    }
    else
    {
        more138.style.display = "inline";
        learningGoalsBackground.style.padding = "2px 2px 15px 20px";
    }
}
